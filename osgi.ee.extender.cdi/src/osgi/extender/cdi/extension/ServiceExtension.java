...
/**
 * Standard CDI extension for handling OSGi services within CDI. Takes care of handling the service logic related to
 * OSGi environments, meaning that it takes care of service registration and service reference injection handling that occur
 * in CDI contexts.
 *
...
public class ServiceExtension implements Extension {
    ...
    private TrackerBean processInjectionPoint(InjectionPoint point, Consumer<Throwable> errorAdder) {
        ...
        if (tracker == null) {
            try {
                tracker = new Tracker<Object>(context, toTrack, subfilter, waitTime);
    ...
    public void afterBeanDiscovery(@Observes AfterBeanDiscovery event) {
        ...
        beans.stream().forEach((b) -> event.addBean(b));
     ...
     *
     * @param val The validation event
