...
/**
 * Tracker for entity manager factories. Factories result automatically in an entity manager that is a thread-local proxy
 * to a real entity manager. That entity manager is completely managed via a transaction manager
 * and therefore the application has no involvement anymore in the handling of transactions.
 * 
